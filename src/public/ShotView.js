...
var ShotView = /*#__PURE__*/function (_Shot) {
  _inherits(ShotView, _Shot);

  var _super = _createSuper(ShotView);

  function ShotView(x, y) {
    var _this;

    var variant = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "miss";

    _classCallCheck(this, ShotView);

    _this = _super.call(this, x, y, variant);
    ...
    _this.setVariant(variant, true);

    return _this;
  }

  _createClass(ShotView, [{
    key: "setVariant",
