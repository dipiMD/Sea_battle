...
function loginValidate(username, password) {
  sendRequest('GET', 'http://localhost:3000/api/user/' + username).then(function (res) {
...
function indexLoad() {
  ...
  sendRequest('GET', 'http://localhost:3000/api/stat/' + user_id).then(function (res) {
...
function updateStat() {
  return _updateStat.apply(this, arguments);
}

function _updateStat() {
  _updateStat = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
var Stat = /*#__PURE__*/_createClass(function Stat(id, user_id, played, wins, singleCage, doubleCage, tripleCage, quadroCage) {
